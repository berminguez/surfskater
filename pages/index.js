...
export default function Home() {
  return (
    <div className='flex flex-col items-center justify-center min-h-screen py-2'>
      ...
      <div className='hero w-full bg-blue-600 relative'>
        <Header />
        <div className='heroImageContainer w-full z-0 absolute bottom-0'>
          <img
            src='/mountains.png'
            className='object-contain object-bottom z-0'
          ></img>
        </div>
        <div className='herocontent py-48 mx-auto max-w-4xl z-50 relative'>
          <h1 className='font-bold text-white text-2xl text-center uppercase'>
            Surfea la ciudad
          </h1>
          <p className='font-regular text-white text-center relative'>
